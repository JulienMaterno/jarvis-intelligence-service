...
from app.api.routes import beeper, briefing, calendar, chat, clarifications, contacts, documents, emails, follow_up, health, journaling, knowledge, memory, transcripts
...
router.include_router(follow_up.router)
